...
(define (derive-product expr var)
  (make-sum (make-product (derive (multiplicand expr) var) (multiplier expr))
...
(define (derive-exp exp var)
  (cond
    ((eq? (exponent exp) 2) (make-product 2 'x))
    (else (make-product (caddr exp) (make-exp (base exp) (- (exponent exp) 1))))
    ))
